...
function _enforce (options, requiredKeys) {
  if (!options) {
    throw new JSperantitoError(PARAMETERS_UNDEFINED, DEFAULT_ERROR_CODE)
  }
  ...
  if (missingRequiredKeys.length) {
    throw new JSperantitoError( PARAMETERS_REQUIRED + ' "' + missingRequiredKeys.join(', ') + '"', DEFAULT_ERROR_CODE)
  }
}
